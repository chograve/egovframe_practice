	...
	<table class="mytable">
		...
		<tr>
			<td colspan="2" class="td4">
				...
				href="boardRemove.do?boardid=${boardid}" class="deletebtn"><input
					type="button" value="삭제"></a> <a
				href="boardReply.do?boardid=${boardid}"><input type="button"
					value="답글"></a> <a href="boardList.do"><input type="button"
					value="목록보기"></a>
			</td>
		</tr>
	</table>
